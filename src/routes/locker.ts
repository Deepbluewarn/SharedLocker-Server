import { cancelLocker, claimLocker, getAllBuildingList, getAllFloorByBuildingName, getLockerList, requestLockerShare, shareLocker } from '../controller/locker.controller.js'
